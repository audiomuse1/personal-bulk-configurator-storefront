...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function mt(t){return gt({...t,state:!0,attribute:!1})}function ft(){return"undefined"!=typeof window&&window.__BULK_CONFIG__?.proxyBase?window.__BULK_CONFIG__.proxyBase:"undefined"!=typeof window&&"localhost"===window.location.hostname?"3000"===window.location.port?"https://light-cow-51.andrewhartfordbac.deno.net":"":"https://light-cow-51.andrewhartfordbac.deno.net"}const bt={proxyBase:ft(),sheetsProxyUrl:function(){if("undefined"!=typeof window&&window.__BULK_CONFIG__?.sheetsProxyUrl)return window.__BULK_CONFIG__.sheetsProxyUrl;try{return"https://light-cow-51.andrewhartfordbac.deno.net/sheets"}catch{}return ft()+"/api/sheets"}(),cacheTtl:6e5,sessionPrefix:"bulk-config-"},yt=bt.sheetsProxyUrl,xt=bt.cacheTtl,vt=[{id:"front-only",name:"Front Only",sidedness:"one-sided"},{id:"back-only",name:"Back Only",sidedness:"one-sided"},{id:"left-chest",name:"Left Chest",sidedness:"one-sided"},{id:"right-chest",name:"Right Chest",sidedness:"one-sided"},{id:"full-front-full-back",name:"Full Front + Full Back",sidedness:"two-sided"},{id:"full-front-left-chest",name:"Full Front + Left Chest",sidedness:"two-sided"}],kt=[{size:"XS",sizeTier:"standard",sortOrder:1},{size:"S",sizeTier:"standard",sortOrder:2},{size:"M",sizeTier:"standard",sortOrder:3},{size:"L",sizeTier:"standard",sortOrder:4},{size:"XL",sizeTier:"standard",sortOrder:5},{size:"2XL",sizeTier:"2x",sortOrder:6},{size:"3XL",sizeTier:"3x",sortOrder:7},{size:"4XL",sizeTier:"4x",sortOrder:8}],wt=[{id:"standard-unisex",name:"Standard Unisex",brand:"Unisex G64000",tabName:"Standard Unisex",maxSize:"4XL"},{id:"standard-womens",name:"Standard Women's",brand:"Ladies G6400",tabName:"Standard Women's",maxSize:"2XL"},{id:"premium-unisex",name:"Premium Unisex",brand:"Unisex 3001 Canvas",tabName:"Premium Unisex",maxSize:"4XL"},{id:"premium-womens",name:"Premium Women's",brand:"Ladies 6400 Bella",tabName:"Premium Women's",maxSize:"2XL"},{id:"usa-premium-unisex",name:"USA-made Premium Unisex",brand:"Unisex 5001 Royal Apparel",tabName:"USA-made Premium Unisex",maxSize:"4XL"},{id:"usa-premium-womens",name:"USA-made Premium Women's",brand:"Women's 5001W Royal Apparel",tabName:"USA-made Premium Women's",maxSize:"2XL"}];function $t(t){const e=wt.find(e=>e.id===t);if(!e)return kt;const s=kt.find(t=>t.size===e.maxSize)?.sortOrder||99;return kt.filter(t=>t.sortOrder<=s)}let St=null;function Pt(t){const e={};if(!t||t.length<2)return e;const s=t[0],o=[];for(let a=1;a<s.length;a++){const t=s[a];"number"==typeof t&&o.push(t)}const r={NET:"standard","NET 2X":"2x","NET 3X":"3x","NET 4X":"4x"};for(let a=1;a<t.length;a++){const s=t[a];if(!s||!s[0])continue;const l=r[String(s[0]).trim().toUpperCase()];if(!l)continue;const d=[];for(let t=0;t<o.length;t++){const e=s[t+1];if(null==e||""===e)continue;const r="number"==typeof e?e:parseFloat(String(e).replace("$",""));isNaN(r)||d.push({minQty:o[t],maxQty:o[t+1]?o[t+1]-1:null,netPrice:r})}e[l]=d}return e}function Ct(t){const e={},s=[],o=[];let r=-1;for(let a=0;a<t.length;a++){const e=String(t[a]?.[0]||"").trim().toLowerCase();"dark one-sided"===e?o.push({type:"dark-one-sided",startRow:a}):"light one-sided"===e?o.push({type:"light-one-sided",startRow:a}):"dark two-sided"===e?o.push({type:"dark-two-sided",startRow:a}):"light two-sided"===e?o.push({type:"light-two-sided",startRow:a}):"garment color"===e&&(r=a)}for(const a of o){const s=t.slice(a.startRow+1,a.startRow+6);e[a.type]=Pt(s)}if(r>=0)for(let a=r+2;a<t.length;a++){const e=t[a];if(!e||e.length<3)continue;if("Y"!==String(e[0]||"").trim().toUpperCase())continue;const o=String(e[1]||"").trim();let r=String(e[2]||"").trim();"number"==typeof e[2]&&(r=String(e[2]).padStart(6,"0"));const l=r.replace("#",""),d=(299*(parseInt(l.substring(0,2),16)||0)+587*(parseInt(l.substring(2,4),16)||0)+114*(parseInt(l.substring(4,6),16)||0))/1e3>160?"light":"dark";s.push({name:o,hex:l,brightness:d})}return{pricing:e,colors:s}}async function zt(){const t=function(){if(St&&Date.now()-St.fetchedAt<xt)return St;try{const t=sessionStorage.getItem("bulk-tshirt-data");if(!t)return null;const e=JSON.parse(t);return Date.now()-e.fetchedAt>xt?null:(St=e,St)}catch{return null}}();if(t)return t;try{const t=await fetch(yt);if(!t.ok)throw new Error("Proxy error: "+t.status);const e=await t.json(),s={},o={};for(const a of wt){const t=e.tabs[a.tabName];if(!t){console.warn("Tab not found: "+a.tabName);continue}const r=Ct(t);o[a.id]=r.pricing,s[a.id]=r.colors,console.log("Parsed "+a.tabName+": "+Object.keys(r.pricing).length+" pricing sections, "+r.colors.length+" colors")}const r={styles:wt,sizes:kt,printLocations:vt,colors:s,pricing:o,fetchedAt:Date.now()};return function(t){St=t;try{sessionStorage.setItem("bulk-tshirt-data",JSON.stringify(t))}catch{}}(r),console.log("Sheet data loaded and cached"),r}catch(e){return console.error("Failed to load sheet data:",e),{styles:wt,sizes:kt,printLocations:vt,colors:{},pricing:{},fetchedAt:Date.now()}}}function Qt(t,e,s,o,r,a){const l=r.printLocations.find(t=>t.id===e),d=l?l.sidedness:"one-sided",c=s.replace("#",""),p=((299*(parseInt(c.substring(0,2),16)||0)+587*(parseInt(c.substring(2,4),16)||0)+114*(parseInt(c.substring(4,6),16)||0))/1e3>160?"light":"dark")+"-"+d,h=r.pricing[t];if(!h)return{printType:p,lines:[],totalQuantity:0,totalPrice:0};const u=h[p];if(!u)return{printType:p,lines:[],totalQuantity:0,totalPrice:0};const g=o.reduce((t,e)=>t+e.quantity,0),m=null!=a?a:g,f=[];let b=0,x=0;for(const v of o){if(v.quantity<=0)continue;const t=u[v.sizeTier];if(!t||0===t.length)continue;let e=null;for(const r of t){if(!(m>=r.minQty))break;e=r}e||(e=t[0]);const s=Math.round(100*e.netPrice)/100,o=Math.round(s*v.quantity*100)/100;f.push({size:v.size,sizeTier:v.sizeTier,quantity:v.quantity,unitPrice:s,lineTotal:o}),b+=v.quantity,x+=o}return{printType:p,lines:f,totalQuantity:b,totalPrice:Math.round(100*x)/100}}var qt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,At=(t,e,s,o)=>{for(var r,a=o>1?void 0:o?Ft(e,s):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(o?r(e,s,a):r(a))||a);return o&&a&&qt(e,s,a),a};t.InfoTooltip=class InfoTooltip extends i{constructor(){super(...arguments),this.position="left",this._visible=!1,this._hideTimer=null,this._boundOutsideClick=this._onOutsideClick.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._boundOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._boundOutsideClick),this._hideTimer&&clearTimeout(this._hideTimer)}_onOutsideClick(t){if(!this._visible)return;t.composedPath().includes(this)||(this._visible=!1)}_onBtnClick(t){t.stopPropagation(),this._visible=!this._visible}_onMouseEnter(){this._hideTimer&&(clearTimeout(this._hideTimer),this._hideTimer=null),this._visible=!0}_onMouseLeave(){this._hideTimer=window.setTimeout(()=>{this._visible=!1},300)}_onClose(t){t.stopPropagation(),this._visible=!1}render(){return tt`
      <div
  ...
  `,ee([mt()],se.prototype,"selectedSize",2),ee([mt()],se.prototype,"qtyMode",2),ee([mt()],se.prototype,"selectedQtyIndex",2),ee([mt()],se.prototype,"customQty",2),ee([mt()],se.prototype,"priceResult",2),ee([mt()],se.prototype,"showValidation",2),se=ee([pt("step-button-config")],se);const oe=[{id:"11oz-nonusa-white",label:"11oz Non-USA White",size:"11oz",origin:"Non-USA",color:"White",description:"11oz white ceramic mug"},{id:"11oz-nonusa-black",label:"11oz Non-USA Black",size:"11oz",origin:"Non-USA",color:"Black",description:"11oz black ceramic mug"},{id:"11oz-usa-white",label:"11oz USA-made White",size:"11oz",origin:"USA-made",color:"White",description:"11oz USA-made white ceramic mug"},{id:"15oz-usa-white",label:"15oz USA-made White",size:"15oz",origin:"USA-made",color:"White",description:"15oz USA-made white ceramic mug"}],re={"11oz-nonusa-white":[{minQty:1,maxQty:1,price:22.24},{minQty:2,maxQty:4,price:14.74},{minQty:5,maxQty:8,price:10.24},{minQty:9,maxQty:23,price:8.91},{minQty:24,maxQty:35,price:7.86},{minQty:36,maxQty:71,price:7.66},{minQty:72,maxQty:107,price:7.45},{minQty:108,maxQty:143,price:7.45},{minQty:144,maxQty:null,price:7.45}],"11oz-nonusa-black":[{minQty:1,maxQty:1,price:23.52},{minQty:2,maxQty:4,price:16.02},{minQty:5,maxQty:8,price:11.52},{minQty:9,maxQty:23,price:10.18},{minQty:24,maxQty:35,price:9.14},{minQty:36,maxQty:71,price:8.93},{minQty:72,maxQty:107,price:8.73},{minQty:108,maxQty:143,price:8.66},{minQty:144,maxQty:null,price:8.52}],"11oz-usa-white":[{minQty:1,maxQty:1,price:28.07},{minQty:2,maxQty:4,price:20.57},{minQty:5,maxQty:8,price:16.07},{minQty:9,maxQty:23,price:14.74},{minQty:24,maxQty:35,price:13.7},{minQty:36,maxQty:71,price:13.49},{minQty:72,maxQty:107,price:13.28},{minQty:108,maxQty:143,price:13.28},{minQty:144,maxQty:null,price:13.18}],"15oz-usa-white":[{minQty:1,maxQty:1,price:29.58},{minQty:2,maxQty:4,price:22.18},{minQty:5,maxQty:8,price:17.75},{minQty:9,maxQty:23,price:16.43},{minQty:24,maxQty:35,price:15.41},{minQty:36,maxQty:71,price:15.2},{minQty:72,maxQty:107,price:14.99},{minQty:108,maxQty:143,price:14.99},{minQty:144,maxQty:null,price:14.99}]};var ne=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,le=(t,e,s,o)=>{for(var r,a=o>1?void 0:o?ae(e,s):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(o?r(e,s,a):r(a))||a);return o&&a&&ne(e,s,a),a};function de(t){return"$"+t.toFixed(2)}let ce=class extends i{constructor(){super(...arguments),this.selectedStyle=null,this.quantity=0,this.includePackaging=!1,this.priceResult=null,this.showValidation=!1}get styleValid(){return!!this.selectedStyle}get quantityValid(){return this.quantity>0}get allValid(){return this.styleValid&&this.quantityValid}validate(){if(this.showValidation=!0,!this.allValid){const t=this.shadowRoot?.querySelector(".card.invalid-highlight");return t&&t.scrollIntoView({behavior:"smooth",block:"center"}),!1}return!0}onStyleSelect(t){this.selectedStyle=t,this.doPrice()}onQuantityChange(t){this.quantity=parseInt(t.target.value)||0,this.doPrice()}onPackagingToggle(t){t.preventDefault(),this.includePackaging=!this.includePackaging,this.doPrice()}doPrice(){if(!this.selectedStyle||this.quantity<=0)return this.priceResult=null,void this.dispatchStepData(null);const t=function(t,e,s){if(e<=0)return null;const o=oe.find(e=>e.id===t);if(!o)return null;const r=re[t];if(!r||0===r.length)return null;let a=null;for(const u of r){if(!(e>=u.minQty))break;a=u}a||(a=r[0]);const l=Math.round(100*a.price)/100,d=Math.round(l*e*100)/100,c=s?2.5:0,p=Math.round(c*e*100)/100,h=Math.round(2.5*e*100)/100;return{style:o,quantity:e,unitPrice:l,subtotal:d,packagingPerMug:c,packagingTotal:p,includePackaging:s,shippingPerMug:2.5,shippingTotal:h,totalPrice:Math.round(100*(d+p+h))/100,bracketLabel:a.maxQty?a.minQty+"–"+a.maxQty:a.minQty+"+"}}(this.selectedStyle.id,this.quantity,this.includePackaging);this.priceResult=t,this.dispatchStepData(t)}dispatchStepData(t){this.dispatchEvent(new CustomEvent("step-data",{detail:{mugStyle:this.selectedStyle,quantity:this.quantity,includePackaging:this.includePackaging,priceResult:t?{totalQuantity:t.quantity,totalPrice:t.totalPrice,unitPrice:t.unitPrice}:null,mugPriceDetail:t},bubbles:!0,composed:!0}))}cardClass(t){return this.showValidation?"card"+(t?" valid":" invalid-highlight"):"card"+(t?" valid":"")}statusIcon(t){return t?"✓":""}statusClass(t){return"status "+(t?"done":"needed")}renderChecklist(){const t=[{label:"Mug Style",done:this.styleValid},{label:"Quantity (at least 1)",done:this.quantityValid}];return t.every(t=>t.done)?tt``:tt`
    ...
    `}renderPriceTable(){if(!this.selectedStyle)return tt``;const t=(e=this.selectedStyle.id,re[e]||[]);var e;return tt`
      <table class="price-table">
        <thead><tr><th>Quantity</th><th>Price Each</th></tr></thead>
        <tbody>
  ...
  `,le([mt()],ce.prototype,"selectedStyle",2),le([mt()],ce.prototype,"quantity",2),le([mt()],ce.prototype,"includePackaging",2),le([mt()],ce.prototype,"priceResult",2),le([mt()],ce.prototype,"showValidation",2),ce=le([pt("step-mug-config")],ce);const pe=24,he=[{id:"one-sided",label:"1-Sided Print"},{id:"two-sided",label:"2-Sided Print (front & back)"}],ue=[{id:"white",name:"White",hex:"FFFFFF",brightness:"light"},{id:"black",name:"Black",hex:"000000",brightness:"dark"},{id:"navy",name:"Navy Blue",hex:"1B2A4A",brightness:"dark"},{id:"royal-blue",name:"Royal Blue",hex:"1A5EC7",brightness:"dark"},{id:"light-blue",name:"Light Blue",hex:"87CEEB",brightness:"light"},{id:"red",name:"Red",hex:"CC0000",brightness:"dark"},{id:"maroon",name:"Maroon",hex:"6B1C2A",brightness:"dark"},{id:"orange",name:"Orange",hex:"FF6600",brightness:"dark"},{id:"burnt-orange",name:"Burnt Orange",hex:"CC5500",brightness:"dark"},{id:"gold",name:"Gold / Athletic Yellow",hex:"FFD700",brightness:"light"},{id:"yellow",name:"Yellow",hex:"FFEE00",brightness:"light"},{id:"kelly-green",name:"Kelly Green",hex:"2E8B57",brightness:"dark"},{id:"lime-green",name:"Lime Green",hex:"76C043",brightness:"light"},{id:"hunter-green",name:"Hunter Green",hex:"2D5A27",brightness:"dark"},{id:"teal",name:"Teal",hex:"008080",brightness:"dark"},{id:"purple",name:"Purple",hex:"6B2D8B",brightness:"dark"},{id:"lavender",name:"Lavender",hex:"B19CD9",brightness:"light"},{id:"pink",name:"Pink",hex:"FF69B4",brightness:"light"},{id:"hot-pink",name:"Hot Pink",hex:"FF1493",brightness:"dark"},{id:"gray",name:"Gray",hex:"808080",brightness:"dark"},{id:"charcoal",name:"Charcoal",hex:"36454F",brightness:"dark"},{id:"brown",name:"Brown",hex:"6B4226",brightness:"dark"},{id:"tan",name:"Tan / Khaki",hex:"D2B48C",brightness:"light"},{id:"coral",name:"Coral",hex:"FF7F50",brightness:"light"},{id:"neon-green",name:"Neon Green",hex:"39FF14",brightness:"light"},{id:"neon-orange",name:"Neon Orange",hex:"FF6103",brightness:"dark"},{id:"neon-pink",name:"Neon Pink",hex:"FF10F0",brightness:"dark"},{id:"camo",name:"Camo Green",hex:"4B5320",brightness:"dark"}],ge=[{minQty:24,maxQty:36,netPrice:2.83},{minQty:37,maxQty:72,netPrice:2.5},{minQty:73,maxQty:250,netPrice:2.2},{minQty:251,maxQty:500,netPrice:1.98},{minQty:501,maxQty:1e3,netPrice:1.93},{minQty:1001,maxQty:null,netPrice:1.89}],me=[{minQty:24,maxQty:36,netPrice:4.01},{minQty:37,maxQty:72,netPrice:3.68},{minQty:73,maxQty:250,netPrice:3.38},{minQty:251,maxQty:500,netPrice:3.16},{minQty:501,maxQty:1e3,netPrice:3.12},{minQty:1001,maxQty:null,netPrice:3.07}];function fe(t){return"two-sided"===t?me:ge}const be=[24,48,72,100,150,250,500,1e3];var ye=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,ve=(t,e,s,o)=>{for(var r,a=o>1?void 0:o?xe(e,s):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(o?r(e,s,a):r(a))||a);return o&&a&&ye(e,s,a),a};function ke(t){return"$"+t.toFixed(2)}let we=class extends i{constructor(){super(...arguments),this.selectedPrintSide=null,this.selectedColor=null,this.qtyMode="preset",this.selectedQtyIndex=-1,this.customQty=0,this.priceResult=null,this.showValidation=!1}get quantity(){return"preset"===this.qtyMode&&this.selectedQtyIndex>=0?be[this.selectedQtyIndex]:this.customQty}get printSideValid(){return!!this.selectedPrintSide}get colorValid(){return!!this.selectedColor}get quantityValid(){return this.quantity>=pe}get allValid(){return this.printSideValid&&this.colorValid&&this.quantityValid}validate(){if(this.showValidation=!0,!this.allValid){const t=this.shadowRoot?.querySelector(".card.invalid-highlight");return t&&t.scrollIntoView({behavior:"smooth",block:"center"}),!1}return!(this.priceResult&&!this.priceResult.meetsMinimum)}onPrintSideSelect(t){this.selectedPrintSide=t,this.doPrice()}onColorSelect(t){this.selectedColor=t,this.doPrice()}onPresetQtySelect(t){this.qtyMode="preset",this.selectedQtyIndex=t,this.doPrice()}onCustomQtyClick(){this.qtyMode="custom",this.selectedQtyIndex=-1,this.doPrice()}onCustomQtyChange(t){this.customQty=parseInt(t.target.value)||0,this.doPrice()}doPrice(){if(!this.selectedColor||!this.selectedPrintSide||this.quantity<=0)return this.priceResult=null,void this.dispatchStepData(null);const t=function(t,e,s){if(s<=0)return null;const o=ue.find(e=>e.id===t);if(!o)return null;const r=he.find(t=>t.id===e);if(!r)return null;const a=s>=pe,l=fe(e);let d=null;for(const p of l){if(!(s>=p.minQty))break;d=p}d||(d=l[0]);const c=Math.round(100*d.netPrice)/100;return{color:o,printSide:r,quantity:s,unitPrice:c,totalPrice:Math.round(c*s*100)/100,bracketLabel:d.maxQty?d.minQty+"–"+d.maxQty:d.minQty+"+",meetsMinimum:a}}(this.selectedColor.id,this.selectedPrintSide.id,this.quantity);this.priceResult=t,this.dispatchStepData(t)}dispatchStepData(t){this.dispatchEvent(new CustomEvent("step-data",{detail:{coolerColor:this.selectedColor,coolerPrintSide:this.selectedPrintSide,quantity:this.quantity,priceResult:t?{totalQuantity:t.quantity,totalPrice:t.totalPrice,unitPrice:t.unitPrice}:null,coolerPriceDetail:t},bubbles:!0,composed:!0}))}cardClass(t){return this.showValidation?"card"+(t?" valid":" invalid-highlight"):"card"+(t?" valid":"")}statusIcon(t){return t?"✓":""}statusClass(t){return"status "+(t?"done":"needed")}renderChecklist(){const t=[{label:"Print Sides",done:this.printSideValid},{label:"Cooler Color",done:this.colorValid},{label:"Quantity (minimum 24)",done:this.quantityValid}];return t.every(t=>t.done)?tt``:tt`
    ...
    `}renderPriceTable(){if(!this.selectedPrintSide)return tt``;const t=fe(this.selectedPrintSide.id);return tt`
      <table class="price-table">
        ...
        <tbody>
          ${t.map(t=>{const e=t.maxQty?t.minQty+"–"+t.maxQty:t.minQty+"+",s=this.priceResult&&this.quantity>=t.minQty&&(null===t.maxQty||this.quantity<=t.maxQty);return tt`<tr class="${s?"current":""}"><td>${e}</td><td>${ke(t.netPrice)}</td></tr>`})}
        </tbody>
      </table>
    `}renderPriceArea(){if(this.priceResult){const t=this.priceResult,e=ke(t.totalPrice),s=ke(t.unitPrice);return tt`
        <div class="price-display">
          <div class="price-main">${e}</div>
          <div class="price-per-unit">${s} Ea.</div>
          <div class="price-detail">
  ...
  `,Ae([mt()],Te.prototype,"selectedPrintSide",2),Ae([mt()],Te.prototype,"quantity",2),Ae([mt()],Te.prototype,"fullBleed",2),Ae([mt()],Te.prototype,"selectedStake",2),Ae([mt()],Te.prototype,"priceResult",2),Ae([mt()],Te.prototype,"showValidation",2),Te=Ae([pt("step-yardsign-config")],Te);const _e=l`
  :host {
    display: block;
...
`;var Ve=Object.defineProperty,Ee=Object.getOwnPropertyDescriptor,De=(t,e,s,o)=>{for(var r,a=o>1?void 0:o?Ee(e,s):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(o?r(e,s,a):r(a))||a);return o&&a&&Ve(e,s,a),a};const Oe=".eps,.ai,.psd,.png,.jpg,.jpeg,.gif,.bmp,.svg,.tiff,.tif,.pdf",Le=[".eps",".ai",".svg",".pdf",".psd"],Ue={tshirt:{area:'12" × 16" print area',notes:"Vector files (AI, EPS, SVG) or 300 DPI raster images preferred. For dark garments, provide artwork on a transparent background."},sticker:{area:'Up to 6" × 6" depending on shape',notes:'Vector files strongly recommended for clean edges. Include 1/8" bleed outside the cut line.'},button:{area:"Circular print area based on button size",notes:"Keep important elements away from edges — artwork wraps around the button. Vector preferred."},mug:{area:'8.5" × 3.5" wrap area',notes:"Artwork wraps around the mug. Provide as a flat rectangle. 300 DPI minimum for photo-quality."},cancooler:{area:'8" × 3.5" per side',notes:"Similar to mugs — artwork wraps around the cooler. Vector or 300 DPI raster."},yardsign:{area:'Varies by sign size (e.g., 24" × 18")',notes:"Signs are viewed from a distance — bold text and high contrast work best. Vector preferred."}};let Me=class extends i{constructor(){super(...arguments),this.printLocationId="",this.sidedness="one-sided",this.productType="",this.artworkOption="upload",this.frontFileName="",this.frontFilePreview="",this.frontFileError="",this.frontFileAnalysis=null,this.frontDragOver=!1,this.frontFile=null,this.backFileName="",this.backFilePreview="",this.backFileError="",this.backFileAnalysis=null,this.backDragOver=!1,this.backFile=null,this.showValidation=!1}get isTwoSided(){return"two-sided"===this.sidedness}getUploadLabels(){switch(this.printLocationId){case"front-only":return["Front Artwork"];case"back-only":return["Back Artwork"];case"left-chest":return["Left Chest Artwork"];case"right-chest":return["Right Chest Artwork"];case"full-front-full-back":return["Front Artwork","Back Artwork"];case"full-front-left-chest":return["Front Artwork","Left Chest Artwork"];default:return this.isTwoSided?["Front Artwork","Back Artwork"]:["Artwork"]}}get frontValid(){return"upload"!==this.artworkOption||!!this.frontFileName}get backValid(){return"upload"!==this.artworkOption||(!this.isTwoSided||!!this.backFileName)}get isComplete(){return"email"===this.artworkOption||"help"===this.artworkOption||(this.isTwoSided?!(!this.frontFileName||!this.backFileName):!!this.frontFileName)}validate(){if(this.showValidation=!0,!this.isComplete){const t=this.shadowRoot?.querySelector(".upload-section.invalid-highlight");return t&&t.scrollIntoView({behavior:"smooth",block:"center"}),!1}return!0}clearAllFiles(){this.frontFile=null,this.frontFileName="",this.frontFilePreview="",this.frontFileError="",this.frontFileAnalysis=null,this.backFile=null,this.backFileName="",this.backFilePreview="",this.backFileError="",this.backFileAnalysis=null}dispatchData(){const t="upload"===this.artworkOption;this.dispatchEvent(new CustomEvent("step-data",{detail:{artworkOption:this.artworkOption,file:t?this.frontFile:null,backFile:t?this.backFile:null,frontFileName:t?this.frontFileName:"",backFileName:t?this.backFileName:""},bubbles:!0,composed:!0}))}onOptionChange(t){this.artworkOption=t,this.showValidation=!1,"upload"!==t&&this.clearAllFiles(),this.dispatchData()}getFileExtension(t){return"."+(t.split(".").pop()?.toLowerCase()||"")}isVectorFile(t){return Le.includes(this.getFileExtension(t))}formatFileSize(t){return t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}validateFile(t){if(t.size>20971520)return"File is too large. Maximum size is 20 MB.";const e=this.getFileExtension(t.name);return Oe.split(",").includes(e)?null:`File type "${e}" not accepted. Please use: AI, EPS, PSD, PDF, SVG, PNG, JPG, or TIFF.`}async analyzeFile(t){const e=this.getFileExtension(t.name),s=this.isVectorFile(t.name),o={name:t.name,size:t.size,type:t.type,extension:e,isVector:s,dpiWarning:null};if(!s&&t.type.startsWith("image/"))try{const e=await this.getImageDimensions(t);o.width=e.width,o.height=e.height;const s=Math.max(e.width,e.height),r=Math.round(s/12);o.dpi=r,r<150?o.dpiWarning="very-low":r<300&&(o.dpiWarning="low")}catch{}return o}getImageDimensions(t){return new Promise((e,s)=>{const o=new Image,r=URL.createObjectURL(t);o.onload=()=>{e({width:o.naturalWidth,height:o.naturalHeight}),URL.revokeObjectURL(r)},o.onerror=()=>{URL.revokeObjectURL(r),s(new Error("Could not load image"))},o.src=r})}async processFile(t,e){const s=this.validateFile(t);if(s)return void("front"===e?this.frontFileError=s:this.backFileError=s);const o=await this.analyzeFile(t);if("front"===e?(this.frontFile=t,this.frontFileName=t.name,this.frontFilePreview="",this.frontFileError="",this.frontFileAnalysis=o):(this.backFile=t,this.backFileName=t.name,this.backFilePreview="",this.backFileError="",this.backFileAnalysis=o),t.type.startsWith("image/")){const s=new FileReader;s.onload=()=>{"front"===e?this.frontFilePreview=s.result:this.backFilePreview=s.result},s.readAsDataURL(t)}this.dispatchData()}onDragOver(t,e){t.preventDefault(),t.stopPropagation(),"front"===e?this.frontDragOver=!0:this.backDragOver=!0}onDragLeave(t,e){t.preventDefault(),t.stopPropagation(),"front"===e?this.frontDragOver=!1:this.backDragOver=!1}onDrop(t,e){t.preventDefault(),t.stopPropagation(),"front"===e?this.frontDragOver=!1:this.backDragOver=!1;const s=t.dataTransfer?.files?.[0];s&&this.processFile(s,e)}onFrontFileChange(t){const e=t.target.files?.[0];e&&this.processFile(e,"front")}onBackFileChange(t){const e=t.target.files?.[0];e&&this.processFile(e,"back")}removeFrontFile(){this.frontFile=null,this.frontFileName="",this.frontFilePreview="",this.frontFileError="",this.frontFileAnalysis=null,this.dispatchData()}removeBackFile(){this.backFile=null,this.backFileName="",this.backFilePreview="",this.backFileError="",this.backFileAnalysis=null,this.dispatchData()}uploadSectionClass(t){return this.showValidation?"upload-section"+(t?" valid":" invalid-highlight"):"upload-section"+(t?" valid":"")}renderDpiBadge(t){return t?t.isVector?tt`<span class="dpi-badge vector">✓ Vector — print-ready</span>`:t.dpi?"very-low"===t.dpiWarning?tt`<span class="dpi-badge very-low">⚠ ~${t.dpi} DPI — may print poorly</span>`:"low"===t.dpiWarning?tt`<span class="dpi-badge low">⚠ ~${t.dpi} DPI — below 300 recommended</span>`:tt`<span class="dpi-badge good">✓ ~${t.dpi} DPI</span>`:tt``:tt``}renderDpiWarning(t){return t&&t.dpiWarning?"very-low"===t.dpiWarning?tt`
        <div class="dpi-warning very-low">
          <strong>⚠️ Low resolution detected.</strong> This image is approximately ${t.dpi} DPI
      ...
      `:"low"===t.dpiWarning?tt`
        <div class="dpi-warning low">
          <strong>⚠️ Resolution note:</strong> This image is approximately ${t.dpi} DPI at print
          size. 300 DPI is recommended for best quality. It may still print acceptably depending on
          the design.
        </div>
      `:tt``:tt``}renderUploadSlot(t,e,s,o,r,a,l,d,c,p,h){return tt`
      <div class="${this.uploadSectionClass(a)}">
        <p class="upload-section-title">
          <span>${t}</span>
          <span class="status ${a?"done":"needed"}">
            ${a?"✓ Uploaded":"Required"}
          </span>
        </p>
        ...
        ${e&&r?tt`
              <div class="file-display">
                ${s?tt`<img class="file-preview-thumb" src=${s} alt="Preview" />`:tt`
                ...
                <div class="file-details">
                  <div class="file-details-name">${e}</div>
                  <div class="file-details-meta">
                    ${this.formatFileSize(r.size)}
                    ${r.width?tt` · ${r.width} × ${r.height}px`:""}
                  </div>
                  ${this.renderDpiBadge(r)}
                </div>
                <button class="file-remove-btn" @click=${p}>Remove</button>
              </div>
              ${this.renderDpiWarning(r)}
            `:tt`
              <div
                class="drop-zone ${l?"drag-over":""}"
                @dragover=${t=>this.onDragOver(t,d)}
                @dragleave=${t=>this.onDragLeave(t,d)}
                @drop=${t=>this.onDrop(t,d)}
                @click=${()=>{const t=this.shadowRoot?.getElementById(h);t?.click()}}
              >
              ...
              <input
                ...
                @change=${c}
              />
              ${this.showValidation&&!a?tt`<div class="missing-prompt">⚠️ Please upload your ${t.toLowerCase()}</div>`:tt``}
            `}
        ${o?tt`<p class="file-error">⚠️ ${o}</p>`:tt``}
      </div>
    `}renderArtworkSpecs(){const t=Ue[this.productType];return t?tt`
      <div class="artwork-specs">
        <div class="artwork-specs-title">
          🎨 Artwork Specifications
        </div>
        <div class="artwork-specs-area">📐 ${t.area}</div>
        <div class="artwork-specs-notes">${t.notes}</div>
      </div>
    `:tt``}renderChecklist(){if("upload"!==this.artworkOption)return tt``;const t=this.getUploadLabels(),e=[{label:t[0],done:this.frontValid}];this.isTwoSided&&t.length>1&&e.push({label:t[1],done:this.backValid});return e.every(t=>t.done)?tt``:tt`
      <div class="checklist">
      ...
      <div class="step-card">
        ...
        <div class="step-body">
          ...
          ${"upload"===this.artworkOption?tt`
                <hr />
                ${this.renderChecklist()}
                ${this.renderUploadSlot(t[0],this.frontFileName,this.frontFilePreview,this.frontFileError,this.frontFileAnalysis,this.frontValid,this.frontDragOver,"front",t=>this.onFrontFileChange(t),()=>this.removeFrontFile(),"front-file-input")}
                ${this.isTwoSided&&t.length>1?tt`
                      ${this.renderUploadSlot(t[1],this.backFileName,this.backFilePreview,this.backFileError,this.backFileAnalysis,this.backValid,this.backDragOver,"back",t=>this.onBackFileChange(t),()=>this.removeBackFile(),"back-file-input")}
                    `:tt``}
              `:tt``}
    ...
    `}};Me.styles=[_e,l`
      ...
      .checklist-item.pending { color: #e67e22; }
    `],De([gt({type:String})],Me.prototype,"printLocationId",2),De([gt({type:String})],Me.prototype,"sidedness",2),De([gt({type:String})],Me.prototype,"productType",2),De([mt()],Me.prototype,"artworkOption",2),De([mt()],Me.prototype,"frontFileName",2),De([mt()],Me.prototype,"frontFilePreview",2),De([mt()],Me.prototype,"frontFileError",2),De([mt()],Me.prototype,"frontFileAnalysis",2),De([mt()],Me.prototype,"frontDragOver",2),De([mt()],Me.prototype,"backFileName",2),De([mt()],Me.prototype,"backFilePreview",2),De([mt()],Me.prototype,"backFileError",2),De([mt()],Me.prototype,"backFileAnalysis",2),De([mt()],Me.prototype,"backDragOver",2),De([mt()],Me.prototype,"showValidation",2),Me=De([pt("step-artwork")],Me);var Ne=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,Be=(t,e,s,o)=>{for(var r,a=o>1?void 0:o?Re(e,s):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(o?r(e,s,a):r(a))||a);return o&&a&&Ne(e,s,a),a};let We=class extends i{constructor(){super(...arguments),this.unionLabel=!0}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("step-data",{detail:{unionLabel:this.unionLabel},bubbles:!0,composed:!0}))}get isComplete(){return!0}validate(){return!0}onToggle(t){this.unionLabel=t,this.dispatchEvent(new CustomEvent("step-data",{detail:{unionLabel:t},bubbles:!0,composed:!0}))}render(){return tt`
      <div class="step-card">
        <div class="step-header">
          <info-tooltip>
    ...
    `],Be([mt()],We.prototype,"unionLabel",2),We=Be([pt("step-union-label")],We);var He=Object.defineProperty,je=Object.getOwnPropertyDescriptor,Xe=(t,e,s,o)=>{for(var r,a=o>1?void 0:o?je(e,s):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(o?r(e,s,a):r(a))||a);return o&&a&&He(e,s,a),a};let Ge=class extends i{constructor(){super(...arguments),this.notes=""}get isComplete(){return!0}validate(){return!0}onInput(t){this.notes=t.target.value,this.dispatchEvent(new CustomEvent("step-data",{detail:{notes:this.notes},bubbles:!0,composed:!0}))}render(){return tt`
      <div class="step-card">
        <div class="step-header">
          <info-tooltip>
    ...
    `],ai([gt({type:String})],t.BulkConfigurator.prototype,"productType",2),ai([gt({type:Number})],t.BulkConfigurator.prototype,"productId",2),ai([mt()],t.BulkConfigurator.prototype,"currentStep",2),ai([mt()],t.BulkConfigurator.prototype,"stepData",2),ai([mt()],t.BulkConfigurator.prototype,"toastMessage",2),ai([mt()],t.BulkConfigurator.prototype,"toastType",2),ai([mt()],t.BulkConfigurator.prototype,"toastFading",2),ai([mt()],t.BulkConfigurator.prototype,"addingToCart",2),t.BulkConfigurator=ai([pt("bulk-configurator")],t.BulkConfigurator),t.CONFIG=bt,t.getProductConfig=Ke,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),t}({});
